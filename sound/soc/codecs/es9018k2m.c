	...
	struct snd_soc_dai *dai)
{
	...
	ret = snd_soc_component_read(component, ES9018K2M_INPUT_CONFIG, &reg);
	if (ret)
		return ret;
...
bool es9018k2m_check_chip_id(struct snd_soc_component *component)
{
	...
	value = snd_soc_component_read32(component, SABRE9018Q2C_REG_64);
