...
static int sun6i_spi_probe(struct platform_device *pdev)
{
	...
	sspi->fifo_depth = quirks->fifo_depth;
	sspi->max_burst = quirks->max_burst;
...
static const struct sun6i_spi_quirks suniv_spi_quirks = {
...
static const struct of_device_id sun6i_spi_match[] = {
	{ .compatible = "allwinner,suniv-spi",    .data = &suniv_spi_quirks },
